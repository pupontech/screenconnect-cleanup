...
Check 'steps 1-2 run automatically with no decision prompt' (-not $startHere.Contains('STEP 1/9') -or ($startHere.Contains('STEP 1/9: Tool pack + scanner staging') -and -not $startHere.Contains('set /p GO="    Run now? [Y/n] "')))
