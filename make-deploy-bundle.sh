...
for f in sc-cleanup.ps1 preflight.ps1 collect-snapshot.ps1 diff-snapshots.ps1 \
         ...
         targets.json New-InvestigationReport.ps1 Submit-ConnectWiseReport.ps1 Resolve-MicroBinRunUrl.ps1 Resolve-MicroBinUploaderPassword.ps1 Resolve-IncidentContext.ps1 \
